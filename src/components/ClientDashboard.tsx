  ...
  return (
    <div className="min-h-screen bg-background pb-32">
      ...
      <div className="px-5 space-y-4 mt-2">
        ...
        >
          <span className="text-[11px] text-muted-foreground mr-auto">{lang === 'en' ? 'Contact trainer' : 'Написать тренеру'}:</span>
          <a
            href="https://wa.me/35795144819"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 bg-card border border-border/40 rounded-xl px-3 py-2 hover:border-primary/30 transition-all no-underline"
          >
