    ...
    <section className="relative min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex flex-col items-center px-5">
        ...
        >
          ...
          {/* Contact options — bubble pop animation */}
          <AnimatePresence>
            {showContactOptions && (
              <>
                <motion.a
                  ...
                  animate={{ opacity: 1, scale: [0, 1.3, 0.9, 1.05, 1], y: 0 }}
          ...
          {/* Chat badge + hint — appear/disappear together as one unit */}
          <AnimatePresence>
            {!showContactOptions && (
              <motion.div
              ...
              >
                ...
                <div className="absolute top-1/2 -translate-y-1/2 -right-[7.5rem] z-10 flex items-center gap-1.5">
                  <motion.span
                    animate={{ x: [0, -3, 0] }}
