...
import workoutWeightLoss from '@/assets/workout-weight-loss.jpg';
import workoutMuscleGain from '@/assets/workout-muscle-gain.jpg';
import workoutFlexibility from '@/assets/workout-flexibility.jpg';
import workoutStayFit from '@/assets/workout-stay-fit.jpg';
import workoutPainRelief from '@/assets/workout-pain-relief.jpg';
    ...
    <section className="relative min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex flex-col items-center px-5">
        ...
        <motion.div
          ...
          className="mb-4 flex flex-col items-center gap-3 w-full max-w-xs"
        >
          <motion.button
            key="book"
          ...
          <motion.a
            ...
            className="w-full flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3.5 rounded-2xl text-sm hover:scale-[1.02] transition-all active:scale-[0.98] shadow-[0_4px_20px_-4px_rgba(16,185,129,0.5)]"
          >
